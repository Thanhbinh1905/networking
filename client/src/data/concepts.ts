...
export const concepts: Concept[] = [
	{
		...
		whyNeed: "To physically carry data signals between nearby devices using copper or fiber-optic cables.",
		limitation: "Requires physical wires, limiting movement and scaling beyond local environments.",
	},
	{
		order: 2,
		id: "wi-fi",
		...
		whyNeed: "To connect devices to a network wirelessly through radio signals in the air.",
		limitation: "Signals degrade with distance and physical obstacles, and are susceptible to interference.",
	},
	{
		order: 3,
		id: "mac-address",
		...
		whyNeed: "Every device needs a unique hardware identifier to recognize its neighbors when directly connected.",
		limitation: "Only works locally; you cannot use a MAC address to locate or reach a device on another network.",
	},
	{
		order: 4,
		id: "switch",
		...
		whyNeed: "Connects multiple devices on the same local network, sending data frames only to the port of the target MAC address.",
		limitation: "Only works within the local network segment; cannot forward traffic to other networks.",
	},
	{
		order: 5,
		id: "ip-address",
		...
		whyNeed: "To logically identify and reach devices across different networks worldwide.",
		limitation: "IP addresses can change dynamically, so they are not permanently bound to hardware.",
	},
	{
		order: 6,
		id: "static-ip",
		...
		whyNeed: "To manually assign a fixed, unchanging IP address to servers or printers so they are always reachable at the same address.",
		limitation: "Requires manual configuration on each device, which becomes difficult and error-prone at scale.",
	},
	{
		order: 7,
		id: "dhcp",
		...
		whyNeed: "Automatically assigns IP addresses to devices when they join the network, avoiding manual configuration errors.",
		limitation: "Requires a running DHCP server on the local network; if it goes down, new devices cannot get IPs.",
	},
	{
		order: 8,
		id: "subnet",
		...
		whyNeed: "Defines the boundary and size of your local network, letting your device know who is local and who is remote.",
		limitation: "A subnet division is logical; moving a device to a different range requires changing its configuration.",
	},
	{
		order: 9,
		id: "router",
		...
		whyNeed: "Acts as the exit door to connect different networks, reading destination IPs to forward packets across boundaries.",
		limitation: "Can become a bottleneck or single point of failure if it goes down.",
	},
	{
		order: 10,
		id: "default-gateway",
		...
		whyNeed: "Tells local devices where to send packets when they don't know the path to a remote destination.",
		limitation: "If the gateway IP is misconfigured, the device will be trapped inside its local network.",
	},
	{
		order: 11,
		id: "routes",
		...
		whyNeed: "Defines forwarding rules in a routing table so routers know which path to choose for specific IP destinations.",
		limitation: "Outdated or incorrect routes can lead to routing loops or dropped traffic.",
	},
	{
		order: 12,
		id: "static-routing",
		...
		whyNeed: "Manually configures exact paths between networks, which is secure and uses no bandwidth.",
		limitation: "Does not adapt automatically; if a link fails, traffic is blocked until manual reconfiguration.",
	},
	{
		order: 13,
		id: "ospf",
		...
		whyNeed: "Dynamically shares network links inside an organization so routers automatically find the best and fastest paths.",
		limitation: "Only works within a single organization; is too complex and resource-heavy for global internet scale.",
	},
	{
		order: 14,
		id: "bgp",
		...
		whyNeed: "Allows different independent networks (like ISPs and tech giants) to exchange routing paths, forming the internet.",
		limitation: "Trust-based design makes it vulnerable to configuration errors or routing hijack attacks.",
	},
	{
		order: 15,
		id: "ping",
		...
		whyNeed: "Quickly tests if a remote host is alive and measures the round-trip delay.",
		limitation: "Firewalls often block ping requests, making active hosts appear offline.",
	},
	{
		order: 16,
		id: "icmp",
		...
		whyNeed: "Used by network devices to send diagnostics, error notifications, and operational messages.",
		limitation: "It is a control protocol and cannot be used to transfer user application data.",
	},
	{
		order: 17,
		id: "tcp",
		...
		whyNeed: "Guarantees reliable, error-checked, and in-order delivery of data by establishing a connection first.",
		limitation: "High overhead and latency because it must wait for delivery confirmations before sending more data.",
	},
	{
		order: 18,
		id: "udp",
		...
		whyNeed: "Sends data immediately without handshakes, prioritizing speed over reliability.",
		limitation: "No guarantee of delivery; lost packets are gone forever, requiring applications to handle losses.",
	},
	{
		order: 19,
		id: "ports",
		...
		whyNeed: "Directs traffic to the correct application process on a device, allowing multiple services to run on a single IP.",
	...
	},
	{
		...
		whyNeed: "Controls allowed traffic in and out of a network based on security rules to block hackers and untrusted data.",
		limitation: "Can block legitimate traffic if rules are too strict, or allow attacks if configured poorly.",
	},
	{
		order: 21,
		id: "tls",
		...
		whyNeed: "Encrypts connections (like HTTPS) to prevent eavesdroppers from reading or altering messages in transit.",
		limitation: "Requires cryptographic handshakes, which adds computation time and latency.",
	},
	{
		order: 22,
		id: "ssl",
		...
		whyNeed: "Introduced connection encryption and laid the foundation for modern web security.",
		limitation: "Deprecated and cryptographically insecure; should not be used in modern networks.",
	},
	{
		order: 23,
		id: "vpn",
		...
		whyNeed: "Creates a secure, encrypted tunnel to protect all outgoing and incoming traffic between your device and a private network.",
		limitation: "Adds routing overhead and latency, and requires a trusted VPN provider.",
	},
	{
		order: 24,
		id: "dns",
		...
		whyNeed: "Translates human-readable domain names (google.com) into machine-readable IP addresses.",
		limitation: "If DNS resolution fails or is slow, websites become unreachable even if the physical internet connection is working.",
	},
	{
		order: 25,
		id: "http",
		...
		whyNeed: "Provides a standard format for browsers to request and servers to return web pages and APIs.",
		limitation: "Transfers data in plain text, meaning anyone in the middle can read passwords and cookies.",
	},
	{
		order: 26,
		id: "https",
		...
		whyNeed: "Secures web browsing by running HTTP inside an encrypted TLS connection.",
		limitation: "Relies on certificate authorities; invalid or expired certificates will trigger blocking browser security warnings.",
	},
	{
		order: 27,
		id: "load-balancer",
		...
		whyNeed: "Distributes user traffic across multiple servers to prevent overload and ensure high availability.",
		limitation: "If the load balancer itself fails, all backend servers become unreachable.",
	},
	{
		order: 28,
		id: "review-path",
		...
		whyNeed: "Connects all individual concepts into a unified journey, showing how data encapsulation works from L1 to L7.",
		limitation: "Shows a simplified conceptual model; real-world enterprise traffic involves extra layers of complexity.",
	},
];
